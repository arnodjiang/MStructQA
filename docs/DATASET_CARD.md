...
**Distribution:** This repository provides the construction code, prompts and synthetic examples. Source data is downloaded from pinned upstream repositories; generated artifacts and admission statistics are recorded in local run manifests.
